...
import {
  LayoutDashboard, Users, Bell, MessageSquare, DollarSign,
  Wrench, FileText, LogOut, Menu, Building2,
...
const adminNav = [
  ...
  { icon: Users, label: 'Committee', path: '/admin/committee' },
  ...
  { icon: Wrench, label: 'Facilities', path: '/admin/facilities' },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-4 border-t border-gray-100 space-y-2">
        <div className="px-3 py-2">
          ...
          <p className="text-xs text-accent-600 font-medium">Administrator</p>
        </div>
        <button
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="lg:ml-60 flex-1 flex flex-col min-h-screen">
        <header className="bg-white border-b border-gray-100 px-4 sm:px-6 h-16 flex items-center justify-between sticky top-0 z-20">
          ...
          <span className="text-sm font-semibold text-gray-700 hidden lg:block">Admin Dashboard</span>
          <div className="flex items-center gap-3 ml-auto">
            <div className="w-8 h-8 bg-accent-500 rounded-full flex items-center justify-center text-white text-xs font-bold">
